 ...
 * discovered via {@link java.util.ServiceLoader} at runtime (Fabric today,
 * NeoForge later). Nothing outside {@code com.deds.api} may implement or
 * call this directly — mods go through {@link com.deds.api.Deds}.
 */
