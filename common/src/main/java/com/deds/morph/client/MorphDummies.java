...
import com.deds.morph.client.mixin.EntitySharedFlagsInvoker;
import com.deds.morph.client.mixin.SquidAccessor;
...
public final class MorphDummies {
    ...
    // ------------------------------------------------------------------
    // per-tick upkeep (called from MorphClient.clientTick, at the end of
    // every client tick)
    // ------------------------------------------------------------------
