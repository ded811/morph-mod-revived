 ...
 * check a morph type against the exact vanilla set (spec §A.7). Read through
 * {@code MorphLoader.villagerFearDistance}, whose NeoForge implementation
 * consults NeoForge's data map first.
 */
