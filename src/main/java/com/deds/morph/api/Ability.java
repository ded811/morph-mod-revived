 ...
 * </ul>
 *
 * <p><b>What we deliberately did NOT copy.</b> The reflection trampoline: 26.2 +
 * Fabric has a real optional-dependency story, so a consumer declares
 * {@code "deds_morph"} under {@code suggests}/{@code depends} and calls
 * {@link AbilityRegistry} directly. And {@code postRender()}, which has no
